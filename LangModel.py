...
def calculate_bigram_perplexity(model, sentences):
    ...
    toy_dataset = "According to recent predictions, 85% of customer communication will be conducted without human agents by 2020."
    toy_dataset_test = "According to recent predictions, 85% of customer communication will be conducted without human agents by 2020."
    
    toy_dataset_model_unsmoothed = BigramLanguageModel("According to recent predictions, 85% of customer communication will be conducted without human agents by 2020.")
